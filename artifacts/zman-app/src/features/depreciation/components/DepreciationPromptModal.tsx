          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-ink-2 leading-relaxed">
                ...
                في الميزانية وتقرير الوضع المالي. الربح التشغيلي لن يتأثّر. مناسب
                للأصول صغيرة القيمة أو حين لا تريد تتبّع الإهلاك شهرياً.
              </p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-ink-2 leading-relaxed">
                يُخصَم شهرياً من الربح التشغيلي طوال عمر الأصل النافع. ترى المبلغ
                الشهري في بطاقة «إهلاك الفترة (غير نقدي)» على لوحة القيادة، وتأثيره
                في «الربح التشغيلي (بعد الإهلاك)». مناسب للأصول الكبيرة (آلات، معدات)
                حيث يُعطي صورة أدقّ للربح الفعلي.
              </p>
            </div>
          </div>
        </button>
