      ...
      {allOrders.length === 0 ? (
        isFiltering ? (
          ...
          <EmptyState
            ...
            description="أنشئ طلبك الأول لتسجيل بيانات المنتجات وتتبع حالات التسليم بسهولة."
            steps={[
              "اضغط زر (طلب جديد +) في الأعلى أو الزر العائم",
              "أدخل اسم الزبون، نوع المنتج، والمبلغ والتاريخ",
              "تابع حالة الطلب وشاركه مع الزبون عبر واتساب"
            ]}
            actionLabel="إضافة طلب جديد (+)"
