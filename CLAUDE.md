...
| migrations `0017`–`0025` | ✅ **مطبَّقة كلها** — تحقَّق منها على الإنتاج في 30 تموز 2026 |
...
قاعدة الإنتاج على **Supabase** (`db/client.ts` مكتوب لـ Supavisor). الـ 9 migrations (`0017`–`0025`) **طُبِّقت كلها** — الهيكل وتعديلات البيانات معاً. القسم أدناه محفوظ كمرجع لأي migration جديد.
