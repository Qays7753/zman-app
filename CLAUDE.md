...
## 6. تطبيق قاعدة البيانات ✅ (أُنجز — 30 تموز 2026)

قاعدة الإنتاج على **Supabase** (`db/client.ts` مكتوب لـ Supavisor). الـ 10 migrations (`0017`–`0026`) **طُبِّقت كلها** — الهيكل وتعديلات البيانات معاً. القسم أدناه محفوظ كمرجع لأي migration جديد.
